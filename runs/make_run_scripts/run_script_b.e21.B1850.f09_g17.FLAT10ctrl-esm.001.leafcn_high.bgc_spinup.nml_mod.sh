...
export CESM_CASE_NAME=b.e21.B1850.f09_g17.FLAT10${FLAT10_EXP}.001.${FLAT10_PARAM}.bgc_spinup.nml_mod
...
# This run script
export FILENAME=/glade/u/home/bbuchovecky/cesm_runs/make_run_scripts/run_script_b.e21.B1850.f09_g17.FLAT10${FLAT10_EXP}.001.${FLAT10_PARAM}.bgc_spinup.nml_mod.sh
...
# Change the namelist `lnd_in` to include new variables
