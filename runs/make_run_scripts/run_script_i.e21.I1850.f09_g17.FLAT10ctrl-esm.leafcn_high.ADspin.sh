...
export CESM_CASE_NAME=i.e21.I1850.f09_g17.FLAT10${FLAT10_SIM_TYPE}.${FLAT10_PARAM}.ADspin
...
# This run script
export FILENAME=/glade/u/home/bbuchovecky/cesm_runs/make_run_scripts/run_script_i.e21.I1850.f09_g17.FLAT10${FLAT10_SIM_TYPE}.${FLAT10_PARAM}.ADspin.sh
