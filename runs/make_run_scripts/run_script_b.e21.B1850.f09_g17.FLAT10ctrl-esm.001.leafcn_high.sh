...
export FILENAME=/glade/u/home/bbuchovecky/cesm_runs/make_run_scripts/run_script_b.e21.B1850.f09_g17.FLAT10${FLAT10_EXP}.001.${FLAT10_PARAM}.1year.sh
...
./xmlchange GET_REFCASE=TRUE  # this will get the initial condition/restart files from the RUN_REFDIR=cesm2_init (default)
...
./xmlchange STOP_N=3
./xmlchange RESUBMIT=8  # changed from 16 to 8 after stopping at 0027-12 -> run until 0051-12
